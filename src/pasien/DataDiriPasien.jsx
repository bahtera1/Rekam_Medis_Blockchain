...
export default function DataDiriPasien({
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 max-w-xl mx-auto border border-blue-100 mt-10 transform transition-all duration-300 hover:shadow-2xl">
                ...
                {!showPopup && (
                    <>
                        ...
                        <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); submitDataDiri(); }}>
                            {/* Semua input form */}
                            <div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-blue-700 mb-2">Umur</label>
                                <input
                                    name="umur"
                                    type="number"
                                    min={0}
                            ...
                            <div>
                                <label className="block text-sm font-medium text-blue-700 mb-2">Golongan Darah</label>
                                <input
                                    name="golonganDarah"
                                    type="text"
                                    className="w-full border border-blue-200 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 bg-blue-50 text-gray-800 placeholder-gray-400 focus:outline-none transition-all duration-200"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-blue-700 mb-2">Tanggal Lahir</label>
                                <input
                                    name="tanggalLahir"
                                    type="date"
                                    className="w-full border border-blue-200 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 bg-blue-50 text-gray-800 placeholder-gray-400 focus:outline-none transition-all duration-200"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-blue-700 mb-2">Alamat</label>
                                <textarea
                                    name="alamat"
                                    className="w-full border border-blue-200 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 bg-blue-50 text-gray-800 placeholder-gray-400 focus:outline-none transition-all duration-200"
                                    value={form.alamat}
                            ...
                            <div>
                                <label className="block text-sm font-medium text-blue-700 mb-2">No. Telepon</label>
                                <input
                                    name="noTelepon"
                                    type="tel"
                                    className="w-full border border-blue-200 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 bg-blue-50 text-gray-800 placeholder-gray-400 focus:outline-none transition-all duration-200"
    ...
    // Jika pasien sudah terdaftar, tampilkan data diri dan rekam medis terbaru
    return (
        <div className="max-w-3xl mx-auto mt-10">
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-blue-100 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-gray-700">
                    <p className="flex items-center"><span className="font-semibold text-blue-700 w-24">Nama:</span> {dataDiri.nama || "-"}</p>
                    <p className="flex items-center"><span className="font-semibold text-blue-700 w-24">Umur:</span> {dataDiri.umur || "-"}</p>
                    <p className="flex items-center"><span className="font-semibold text-blue-700 w-24">Golongan Darah:</span> {dataDiri.golonganDarah || "-"}</p>
                    <p className="flex items-center"><span className="font-semibold text-blue-700 w-24">Tanggal Lahir:</span> {dataDiri.tanggalLahir || "-"}</p>
                    <p className="flex items-center"><span className="font-semibold text-blue-700 w-24">Gender:</span> {dataDiri.gender || "-"}</p>
                    <p className="flex items-center"><span className="font-semibold text-blue-700 w-24">Alamat:</span> {dataDiri.alamat || "-"}</p>
                    <p className="flex items-center"><span className="font-semibold text-blue-700 w-24">No. Telepon:</span> {dataDiri.noTelepon || "-"}</p>
                    <p className="flex items-center"><span className="font-semibold text-blue-700 w-24">Email:</span> {dataDiri.email || "-"}</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
                ...
                {rekamMedisTerbaru ? (
                    <div className="space-y-3 text-gray-700">
                        <p className="flex items-center"><span className="font-medium text-blue-700 w-20">ID:</span> {rekamMedisTerbaru.id}</p>
                        <p className="flex items-center"><span className="font-medium text-blue-700 w-20">Diagnosa:</span> {rekamMedisTerbaru.diagnosa}</p>
                        <p className="flex items-center"><span className="font-medium text-blue-700 w-20">Catatan:</span> {rekamMedisTerbaru.catatan}</p>
                        <p className="flex items-center">
                            <span className="font-medium text-blue-700 w-20">Foto:</span>{" "}
                            {rekamMedisTerbaru.foto ? (
                                <a href={rekamMedisTerbaru.foto} className="text-blue-600 hover:text-blue-800 underline transition-colors duration-200" target="_blank" rel="noopener noreferrer">
                                    Lihat Foto
                                </a>
                            ) : (
